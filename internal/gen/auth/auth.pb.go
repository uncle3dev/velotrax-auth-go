...
const file_auth_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\x10.auth.UserDetailR\x04user\"l\n" +
	...
	"\x04user\x18\x01 \x01(\v2\x10.auth.UserDetailR\x04user\"@\n" +
	...
	"\rUpdateProfile\x12\x1a.auth.UpdateProfileRequest\x1a\x1b.auth.UpdateProfileResponseB9Z7github.com/uncle3dev/velotrax-auth-go/internal/gen/authb\x06proto3"
...
var file_auth_proto_goTypes = []any{
	...
	(*UserDetail)(nil),            // 2: auth.UserDetail
	(*GetProfileRequest)(nil),     // 3: auth.GetProfileRequest
	(*GetProfileResponse)(nil),    // 4: auth.GetProfileResponse
	(*UpdateProfileRequest)(nil),  // 5: auth.UpdateProfileRequest
	(*UpdateProfileResponse)(nil), // 6: auth.UpdateProfileResponse
...
var file_auth_proto_depIdxs = []int32{
	2,  // 0: auth.GetProfileResponse.user:type_name -> auth.UserDetail
	2,  // 1: auth.UpdateProfileResponse.user:type_name -> auth.UserDetail
	2,  // 2: auth.LoginResponse.user:type_name -> auth.UserDetail
	...
	3,  // 7: auth.AuthService.GetProfile:input_type -> auth.GetProfileRequest
	...
	4,  // 13: auth.AuthService.GetProfile:output_type -> auth.GetProfileResponse
	6,  // 14: auth.AuthService.UpdateProfile:output_type -> auth.UpdateProfileResponse
